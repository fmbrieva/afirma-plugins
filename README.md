...
| [**`TablaHuellas`**](https://github.com/fmbrieva/afirma-plugins/blob/master/afirma-simple-plugin-tablahuellas/src/main/resources/es/gob/afirma/plugin/tablahuellas/Indice_Documentos_v00r00_signed.pdf?raw=yes)| [**00.01Beta**](https://github.com/fmbrieva/afirma-plugins/blob/master/plugins/TablaHuellas/00.01Beta/afirma-ui-simpleafirma-plugin-tablahuellas_v00r01Beta01.jar?raw=yes)| Crear indice con huellas digitales para un grupo de documentos (expediente)|
