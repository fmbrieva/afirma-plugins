...
import es.gob.afirma.plugin.internallydetachedfolder.Messages;
import es.gob.afirma.plugin.internallydetachedfolder.Propiedades;
 ...
 * 
 */
public class InternallyDetachedFolderConfiguracionPanel extends ConfigurationPanel {
	...
	public InternallyDetachedFolderConfiguracionPanel() {
		...
		botonAnadir = new JButton(Messages.getString("ConfiguracionBotonTexto.1"));
		...
		botonBorrar = new JButton(Messages.getString("ConfiguracionBotonTexto.2"));
